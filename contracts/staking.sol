...
contract StakingLocks {
    ...
    function _initLocks() internal {
        ...
        locks[LockType.HOURS1] = LockData(1 hours, 10);
        locks[LockType.DAYS30] = LockData(2 hours, 12);
        locks[LockType.DAYS180] = LockData(3 hours, 13);
        locks[LockType.DAYS365] = LockData(4 hours, 15);
        locks[LockType.DAYS730] = LockData(5 hours, 20);
    }
}
